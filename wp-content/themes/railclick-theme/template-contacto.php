    ...
    <section class="relative h-[50vh] flex items-center justify-center px-4 sm:px-6 py-4">
        ...
        <div class="relative w-full sm:w-[90vw] max-w-none sm:max-w-none h-[50vh] mx-auto rounded-3xl overflow-hidden border-2 sm:border-4 border-white shadow-lg sm:shadow-2xl">
            ...
            <div class="absolute inset-0">
                <img src="<?php echo esc_url( get_post_meta( get_the_ID(), 'contacto_hero_bg_image', true ) ); ?>" alt="Contacto" class="object-cover w-full h-full" />
                ...
                <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
                    <div class="text-center text-white max-w-4xl mx-auto">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                            <div class="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl p-6 hover:bg-white/25 transition-all duration-300">
    ...
    <section class="py-12 lg:py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <form class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nombre" name="nombre" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            </div>
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                                <input type="email" id="email" name="email" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            </div>
                        </div>
                        
                        <div>
                            <label for="asunto" class="block text-sm font-medium text-gray-700 mb-2">Asunto</label>
                            <input type="text" id="asunto" name="asunto" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        </div>
                        
                        <div>
                            <label for="mensaje" class="block text-sm font-medium text-gray-700 mb-2">Mensaje</label>
                            <textarea id="mensaje" name="mensaje" rows="6" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"></textarea>
                        </div>
                ...
                <div class="space-y-8">
                    <div class="bg-white rounded-2xl shadow-lg p-8">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Información Adicional</h3>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600"><?php echo esc_html( get_post_meta( get_the_ID(), 'contacto_hours', true ) ); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                <div class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white">
                                        ...
                                        <path d="M9 11V9a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
                                        <path d="M9 11h10"/>
                                    </svg>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-2">Tiempo de Respuesta</h4>
                                    <p class="text-gray-600"><?php echo esc_html( get_post_meta( get_the_ID(), 'contacto_response_time', true ) ); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600"><?php echo esc_html( get_post_meta( get_the_ID(), 'contacto_support_info', true ) ); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div class="space-y-4">
                            <?php
                            $faqs = get_post_meta( get_the_ID(), 'contacto_faqs', true );
                            if (!empty($faqs)) {
                                $faq_lines = explode("\n", $faqs);
                                foreach ($faq_lines as $faq) {
                                    if (!empty(trim($faq))) {
                                        $faq_parts = explode('|', $faq);
                                        if (count($faq_parts) == 2) {
                                            echo '<div class="border-b border-gray-200 pb-4">';
                                            echo '<h4 class="font-semibold text-gray-900 mb-2">' . esc_html($faq_parts[0]) . '</h4>';
                                            echo '<p class="text-gray-600">' . esc_html($faq_parts[1]) . '</p>';
                                            echo '</div>';
                                        }
                                    }
                                }
